...
<html>
    ...
    <body>
        ...
        <section id="gallery" class="text-center text-dark mb-3">
            <table class="tbl" style="width:70%; align-items:center">
                <tr style="height:200px">
                    <td></td>
                    <td><h1 style="font-size: 80px;">gallery..</h1></td>
                    <td></td>
                </tr>
                <tr style="height:240px">
                    <td style="width: 50%"><img src="img/plant1.jpg"><br><br><h2>hibiscus</h2><br><br></td>
                    <td style="width: 50%"><img src="img/plant2.jpg"><br><br><h2>caladium</h2><br><br></td>
                    <td style="width: 50%"><img src="img/plant3.jpg"><br><br><h2>canna lily</h2><br><br></td>
                </tr>
                
                <tr style="height:240px">
                    <td style="width: 50%"><img src="img/plant4.jpg"><br><br><h2>bluestem</h2><br><br></td>
                    <td style="width: 50%"><img src="img/plant5.jpg"><br><br><h2>coleus</h2><br><br></td>
                    <td style="width: 50%"><img src="img/plant6.jpg"><br><br><h2>ageratum</h2><br><br></td>
                </tr>
            </table>
        </section>
